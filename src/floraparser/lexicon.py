...
def pickle_lexicon():
    ...
    FREQUENCY = "very|a_little|not_much|sometimes|often|usually|rarely|more_rarely|more_often|generally|never|" \
                "at_least|always|" \
    ...
    TIMING = "at_first|when_young|soon|" \
    ...
    GERUND = "covering|closing|enveloping|surrounding|forming|terminating_in|dehiscing_by|dividing|" \
             ...
             "borne_on|attached_to|united_to|" \
             "united_to_form|united_into|enclosing|covered_in|covered_with".split('|')
